...
#            pe1 = ct.ProfessionalExperience(Identity, Chemical_industry_years, Last_position, Performed_activities)
            ...
            ctl.Save_Sql_address(Identity, Street, City, State, Postal_code, Country, Avaliable_for_change)
            
            ctl.Save_Sql_professional(Identity, Chemical_industry_years, Last_position, Performed_activities)
            
            ctl.Save_Sql_person(Name, Identity, Type_identity, Phone_number, Email_address, Driving_licence, Driving_licence_class)
            
            id_confirm = consult_data("idPerson", "person", Identity)
        
            id_confirm = id_confirm[0][0]
            
            confirm_page (Identity, id_confirm)
