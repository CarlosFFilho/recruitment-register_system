...
def btn_clicked():
    ...
    p1 = Person(entry20.get(), entry19.get(), opcao_selecionada4.get(), entry17.get(), entry16.get(), opcao_selecionada3.get(), opcao_selecionada5.get())
    e1 = Education(entry19.get(), opcao_selecionada6.get(), entry6.get(), entry5.get(), entry4.get(), opcao_selecionada.get())
    a1 = Address(entry19.get(), entry13.get(), entry12.get(), entry11.get(), entry10.get(), entry9.get(), opcao_selecionada2.get())
    pe1 = ProfessionalExperience(entry19.get(), entry2.get(), entry1.get(), entry0.get())
    
    Person.Save_Sql(entry19.get(), entry20.get(), opcao_selecionada4.get(), entry17.get(), entry16.get(), opcao_selecionada3.get(), opcao_selecionada5.get())
    
    Education.Save_Sql(entry19.get(), opcao_selecionada6.get(), entry6.get(), entry5.get(), entry4.get(), opcao_selecionada.get())
    
    Address.Save_Sql(entry19.get(), entry13.get(), entry12.get(), entry11.get(), entry10.get(), entry9.get(), opcao_selecionada2.get())
    
    ProfessionalExperience.Save_Sql(entry19.get(), entry2.get(), entry1.get(), entry0.get())

    id_confirm = consult_data("idPerson", "person", entry19.get())

    id_confirm = id_confirm[0][0]
    
    confirm_page (entry19.get(), id_confirm)
